  ...
  const navItems = [
    {
      ...
      href: "#",
      children: [
        { title: "Health Insurance", href: "/insurance/health", tag: "Compare & Save" },
        { title: "Term Life Insurance", href: "/insurance/life", tag: "1 Crore Cover" },
        { title: "Car Insurance", href: "/insurance/car", tag: "Instant Policy" },
        { title: "Bike Insurance", href: "/insurance/bike", tag: "Starts @ ₹1.5/day" },
        { title: "Travel Insurance", href: "/insurance/travel" },
        { title: "Business/Group Insurance", href: "/insurance/business" },
      ],
    },
    {
      title: "Loans",
      href: "#",
      children: [
        { title: "Personal Loan", href: "/loans/personal", tag: "Best Interest Rate" },
        { title: "Home Loan", href: "/loans/home" },
        { title: "Business Loan", href: "/loans/business", tag: "Collateral Free" },
        { title: "Loan Against Property", href: "/loans/property" },
      ],
    },
    {
      title: "Investments",
      href: "#",
      children: [
        { title: "Mutual Funds", href: "/investments/mutual-funds", tag: "Direct Plans" },
        { title: "SIP (Systematic Investment)", href: "/investments/sip", tag: "From ₹500/m" },
        { title: "Tax Saving Plans (ELSS)", href: "/investments/elss" },
